...
## |:---------------------:|:-----------:|:------------:|
## | Neighbor_Disadvantage | 0.15679404  | 8.900000e-10 |
## |   PopulationDensity   | 0.11194423  | 1.000000e+00 |
## |     Population65      | 0.11181276  | 1.000000e+00 |
## |   NoHealthInsurance   | 0.08181158  | 7.260000e-10 |
## |      NatureParks      | 0.07149633  | 1.000000e+00 |
## |    DrinkingPlaces     | 0.06706055  | 1.000000e+00 |
## |      X.HouseRent      | 0.05510521  | 9.996456e-01 |
## |         Beer          | 0.02648219  | 1.000000e+00 |
## |   MentalHealthPati    | 0.02567837  | 1.000000e+00 |
## |        Casinos        | 0.02185904  | 1.000000e+00 |
```
...
##    variable              `Q-statistic` `P-value`
##    <chr>                         <dbl>     <dbl>
##  1 Neighbor_Disadvantage        0.157   8.90e-10
##  2 PopulationDensity            0.112   1.00e+ 0
##  3 Population65                 0.112   1.00e+ 0
##  4 NoHealthInsurance            0.0818  7.26e-10
##  5 NatureParks                  0.0715  1   e+ 0
##  6 DrinkingPlaces               0.0671  1   e+ 0
##  7 X.HouseRent                  0.0551  1.00e+ 0
##  8 Beer                         0.0265  1   e+ 0
##  9 MentalHealthPati             0.0257  1   e+ 0
## 10 Casinos                      0.0219  1   e+ 0
```
...
## |       variable        | Q-statistic |      P-value      |
## |:---------------------:|:-----------:|:-----------------:|
## |   PopulationDensity   | 0.21864584  | No Pseudo-P Value |
## |    DrinkingPlaces     | 0.18197355  | No Pseudo-P Value |
## | Neighbor_Disadvantage | 0.17593595  | No Pseudo-P Value |
## |        Casinos        | 0.16458415  | No Pseudo-P Value |
## |     Population65      | 0.16136530  | No Pseudo-P Value |
## |      NatureParks      | 0.13484222  | No Pseudo-P Value |
## |         Beer          | 0.10528805  | No Pseudo-P Value |
## |   NoHealthInsurance   | 0.08177180  | No Pseudo-P Value |
## |      X.HouseRent      | 0.07566722  | No Pseudo-P Value |
## |   MentalHealthPati    | 0.07529563  | No Pseudo-P Value |
...
##  5 Population65                 0.161  No Pseudo-P Value
##  6 NatureParks                  0.135  No Pseudo-P Value
##  7 Beer                         0.105  No Pseudo-P Value
##  8 NoHealthInsurance            0.0818 No Pseudo-P Value
##  9 X.HouseRent                  0.0757 No Pseudo-P Value
## 10 MentalHealthPati             0.0753 No Pseudo-P Value
```
