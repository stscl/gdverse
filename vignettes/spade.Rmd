...
``` r
wt3 = sdsfun::spdep_contiguity_swm(depression)
```
...
## |:---------------------:|:------------:|:-----------------:|
## |   Generalhosptials    | 0.713129950  | No Pseudo-P Value |
## |         Beer          | 0.299178193  | No Pseudo-P Value |
## |      NatureParks      | 0.241494175  | No Pseudo-P Value |
## | Neighbor_Disadvantage | 0.223868294  | No Pseudo-P Value |
## |   MentalHealthPati    | 0.218770886  | No Pseudo-P Value |
## |    DrinkingPlaces     | 0.218687191  | No Pseudo-P Value |
## |   NoHealthInsurance   | 0.136173768  | No Pseudo-P Value |
## |     Population65      | 0.104728974  | No Pseudo-P Value |
## |   PopulationFemale    | 0.077133069  | No Pseudo-P Value |
## |        Casinos        | 0.056337671  | No Pseudo-P Value |
## |   PopulationDensity   | -0.002441396 | No Pseudo-P Value |
## |      X.HouseRent      | -0.033097439 | No Pseudo-P Value |
...
##    variable              `Q-statistic` `P-value`        
##    <chr>                         <dbl> <chr>            
##  1 Generalhosptials            0.713   No Pseudo-P Value
##  2 Beer                        0.299   No Pseudo-P Value
##  3 NatureParks                 0.241   No Pseudo-P Value
##  4 Neighbor_Disadvantage       0.224   No Pseudo-P Value
##  5 MentalHealthPati            0.219   No Pseudo-P Value
##  6 DrinkingPlaces              0.219   No Pseudo-P Value
##  7 NoHealthInsurance           0.136   No Pseudo-P Value
##  8 Population65                0.105   No Pseudo-P Value
##  9 PopulationFemale            0.0771  No Pseudo-P Value
## 10 Casinos                     0.0563  No Pseudo-P Value
## 11 PopulationDensity          -0.00244 No Pseudo-P Value
## 12 X.HouseRent                -0.0331  No Pseudo-P Value
```
