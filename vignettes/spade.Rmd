...
## Error in eval(expr, envir, enclos): object 'ushi' not found
boston_spade
## Error in eval(expr, envir, enclos): object 'boston_spade' not found
plot(ushi_spade,slicenum = 3)
## Error in eval(expr, envir, enclos): object 'ushi_spade' not found
```
