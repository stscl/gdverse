...
## Error in eval(expr, envir, enclos): object 'new_ushi' not found
```
...
``` r
ushi_spade = spade(SUHI ~ ., data = ushi, wt = wt3,
                   cores = 12, permutations = 99)
ushi_spade
...
## |:--------:|:-----------:|:-------:|
## |   DAR    | 0.51354520  |  0.01   |
## |   NDVI   | 0.47435470  |  0.01   |
## |   NDWI   | 0.43652650  |  0.02   |
## |   GAR    | 0.42037121  |  0.01   |
## |   RFD    | 0.35902741  |  0.01   |
## |    BD    | 0.35397385  |   NA    |
## |    BH    | 0.32947163  |   NA    |
