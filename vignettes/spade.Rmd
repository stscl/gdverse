...
``` r
depression_spade = spade(Depression_prevelence ~ ., data = depression, wt = wt4, cores = 12)
depression_spade
## ***         Spatial Association Detector         
## 
## |       variable        | Q-statistic |      P-value      |
## |:---------------------:|:-----------:|:-----------------:|
## |        Casinos        |  1.2330489  | No Pseudo-P Value |
## |   Generalhosptials    |  0.5777290  | No Pseudo-P Value |
## |    DrinkingPlaces     |  0.3733018  | No Pseudo-P Value |
## |   PopulationDensity   |  0.3673534  | No Pseudo-P Value |
## | Neighbor_Disadvantage |  0.3577323  | No Pseudo-P Value |
## |      NatureParks      |  0.3422158  | No Pseudo-P Value |
## |         Beer          |  0.3326362  | No Pseudo-P Value |
## |     Population65      |  0.3136113  | No Pseudo-P Value |
## |   NoHealthInsurance   |  0.2598323  | No Pseudo-P Value |
## |      X.HouseRent      |  0.2341995  | No Pseudo-P Value |
## |   PopulationFemale    |  0.2290267  | No Pseudo-P Value |
## |   MentalHealthPati    |  0.1862595  | No Pseudo-P Value |
...
##    variable              `Q-statistic` `P-value`        
##    <chr>                         <dbl> <chr>            
##  1 Casinos                       1.23  No Pseudo-P Value
##  2 Generalhosptials              0.578 No Pseudo-P Value
##  3 DrinkingPlaces                0.373 No Pseudo-P Value
##  4 PopulationDensity             0.367 No Pseudo-P Value
##  5 Neighbor_Disadvantage         0.358 No Pseudo-P Value
##  6 NatureParks                   0.342 No Pseudo-P Value
##  7 Beer                          0.333 No Pseudo-P Value
##  8 Population65                  0.314 No Pseudo-P Value
##  9 NoHealthInsurance             0.260 No Pseudo-P Value
## 10 X.HouseRent                   0.234 No Pseudo-P Value
## 11 PopulationFemale              0.229 No Pseudo-P Value
## 12 MentalHealthPati              0.186 No Pseudo-P Value
```
