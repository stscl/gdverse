...
## Error in `data[, formula.vars[1], drop = TRUE]` at gdverse/R/geodetector.R:235:3:
## ! Can't subset columns that don't exist.
## ✖ Column `NDVIchange` doesn't exist.
ndvi_opgd
## Error in eval(expr, envir, enclos): object 'ndvi_opgd' not found
```
