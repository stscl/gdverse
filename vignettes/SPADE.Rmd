...
![plot of chunk SUHI_LISA](man/figures/spade/SUHI_LISA-1.png)
...
## |:--------:|:-----------:|:------------:|
## |   DAR    | 0.43933223  | 4.880000e-10 |
## |   NDVI   | 0.39709785  | 2.020000e-10 |
## |   GAR    | 0.38226004  | 8.250000e-10 |
## |   RFD    | 0.26695978  | 7.400000e-10 |
## |    BD    | 0.26496790  | 3.250000e-10 |
## |    BH    | 0.24779725  | 8.800000e-11 |
## |   NDWI   | 0.20808065  | 6.590000e-10 |
## |   FAR    | 0.19795883  | 1.350000e-10 |
## |   SVF    | 0.13094230  | 4.970000e-10 |
## |    RL    | 0.12311769  | 8.890000e-10 |
## |   TER    | 0.11640460  | 6.773600e-08 |
## |   WAR    | 0.10615536  | 5.570000e-10 |
## |   LSI    | 0.07673167  | 3.213431e-06 |
## |   DTH    | 0.07628845  | 7.669056e-06 |
## |   DTP    | 0.07478988  | 7.950000e-10 |
## |   DTW    | 0.05575932  | 4.071996e-04 |
## |   DTR    | 0.05285988  | 3.936830e-07 |
...
``` r
usfi_spade = spade(SUHI ~ ., data = st_drop_geometry(usfi),
                   wt = wt3, discnum = 3:22, cores = 6)
## Error in checkForRemoteErrors(val): 6 nodes produced errors; first error: function 'enterRNGScope' not provided by package 'Rcpp'
usfi_spade
## Error in eval(expr, envir, enclos): object 'usfi_spade' not found
plot(usfi_spade,slicenum = 8)
## Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': object 'usfi_spade' not found
```
...
![plot of chunk WAR_Hist](man/figures/spade/WAR_Hist-1.png)
