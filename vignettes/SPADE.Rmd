...
<div class="figure">
<img src="figure/SUHI_LISA-1.png" alt="plot of chunk SUHI_LISA" width="100%" />
...
In the following section we will execute *SPADE* model using  spatial weight matrix `wt2`.

#### run SPADE


``` r
usfi_spade = spade(SUHI ~ ., data = st_drop_geometry(usfi), wt = wt2, discnum = 3:15,
                   discvar = names(select(st_drop_geometry(usfi),-SUHI)),cores = 6)
usfi_spade
## Spatial Stratified Heterogeneity Test 
##  
...
<div class="figure">
<img src="figure/skewness_WAR-1.png" alt="plot of chunk skewness_WAR" width="75%" />
<p class="caption">plot of chunk skewness_WAR</p>
</div>
