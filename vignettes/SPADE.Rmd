...
## # A tibble: 1,037 × 20
##      LPI   LSI   GAR    DAR     WAR   TER  NDVI   NDWI   DTH   DTP    DTR   DTW    BH    BD    RL
##    <dbl> <dbl> <dbl>  <dbl>   <dbl> <dbl> <dbl>  <dbl> <dbl> <dbl>  <dbl> <dbl> <dbl> <dbl> <dbl>
##  1  57.2 10.5  0.630 0.273  2.19e-3 0.979 0.497 -0.356  5.66 1.08  0.934   1.16 3.16  0.635 0.192
##  2  85.7  2.35 0.905 0.0952 0       0.977 0.514 -0.288  5.66 1.41  0.0807  1.57 0.310 0.139 0    
##  3  41.2  7.85 0.436 0.449  6.72e-4 0.972 0.365 -0.296  4.38 1.88  0.516   2.37 3.99  0.671 0.151
##  4  39.1  5.40 0.534 0.377  0       0.966 0.395 -0.299  4.25 1.97  0.442   2.81 4.63  0.634 0.143
##  5  32.0  8.04 0.405 0.437  0       0.968 0.354 -0.302  3.65 1.34  0.615   2.55 4.07  0.642 0.129
##  6  58.3  7.91 0.332 0.615  3.77e-4 0.966 0.312 -0.271  3.69 0.700 0.592   2.25 7.91  0.777 0.232
##  7  98.4  3.34 0.984 0.0161 0       0.948 0.451 -0.248  5.39 1.36  0.124   3.64 0.216 0.111 0    
##  8  44.6 17.6  0.416 0.502  6.72e-4 0.949 0.365 -0.295  5.11 1.20  0.926   2.50 6.49  0.747 0.185
##  9  35.9  9.81 0.464 0.467  1.34e-3 0.936 0.379 -0.309  7.10 2.01  1.03    2.75 5.49  0.692 0.195
## 10  44.3  9.49 0.403 0.504  5.47e-4 0.926 0.310 -0.278  8.51 2.68  0.658   3.20 3.27  0.601 0.127
## # ℹ 1,027 more rows
## # ℹ 5 more variables: RFD <dbl>, SVF <dbl>, FAR <dbl>, SUHI <dbl>, geom <POLYGON [m]>
```
...
##  3 3.04  <int [9]>  <dbl [9]>  ((297391.4 3789405, 297391 3789429, 297390.5 3789454, 297390.1 37…
##  4 3.22  <int [4]>  <dbl [4]>  ((297244.1 3790712, 297240.4 3790729, 297235 3790751, 297229.6 37…
