...
usfi_spade = spade(SUHI ~ ., data = st_drop_geometry(usfi), wt = wt3, discnum = 3:15,
                   discvar = names(select(st_drop_geometry(usfi),-SUHI)),cores = 6, permutations = 0)
usfi_spade
## 
...
## | variable | Q-statistic |      P-value      |
## |:--------:|:-----------:|:-----------------:|
## |   DAR    | 0.50294513  | No Pseudo-P Value |
## |   NDVI   | 0.46896587  | No Pseudo-P Value |
## |   NDWI   | 0.43712397  | No Pseudo-P Value |
## |   GAR    | 0.41994583  | No Pseudo-P Value |
## |   RFD    | 0.39426506  | No Pseudo-P Value |
## |   TER    | 0.39085697  | No Pseudo-P Value |
## |    BD    | 0.36247310  | No Pseudo-P Value |
## |    BH    | 0.32074407  | No Pseudo-P Value |
## |   FAR    | 0.21606930  | No Pseudo-P Value |
## |   DTR    | 0.20022612  | No Pseudo-P Value |
## |   LSI    | 0.16854012  | No Pseudo-P Value |
## |   DTP    | 0.15384871  | No Pseudo-P Value |
## |    RL    | 0.14359774  | No Pseudo-P Value |
## |   LPI    | 0.14236279  | No Pseudo-P Value |
## |   DTW    | 0.13648179  | No Pseudo-P Value |
## |   SVF    | 0.12679746  | No Pseudo-P Value |
## |   DTH    | 0.08442943  | No Pseudo-P Value |
## |   WAR    | -0.23746639 | No Pseudo-P Value |
```
...
##    variable `Q-statistic` `P-value`        
##    <chr>            <dbl> <chr>            
##  1 DAR             0.503  No Pseudo-P Value
##  2 NDVI            0.469  No Pseudo-P Value
##  3 NDWI            0.437  No Pseudo-P Value
##  4 GAR             0.420  No Pseudo-P Value
##  5 RFD             0.394  No Pseudo-P Value
##  6 TER             0.391  No Pseudo-P Value
##  7 BD              0.362  No Pseudo-P Value
##  8 BH              0.321  No Pseudo-P Value
##  9 FAR             0.216  No Pseudo-P Value
## 10 DTR             0.200  No Pseudo-P Value
## 11 LSI             0.169  No Pseudo-P Value
## 12 DTP             0.154  No Pseudo-P Value
## 13 RL              0.144  No Pseudo-P Value
## 14 LPI             0.142  No Pseudo-P Value
## 15 DTW             0.136  No Pseudo-P Value
## 16 SVF             0.127  No Pseudo-P Value
## 17 DTH             0.0844 No Pseudo-P Value
## 18 WAR            -0.237  No Pseudo-P Value
```

The result of `WAR` is very small and You can't even see it in the result histogram above.You can also see a big difference between the OPGD and SPADE model. The results of SPADE are more reliable in most cases.

We demonstrate the rationality of very small values calculated of `WAR` in the following section:

### SPADE very small result explained
...
In fact, the WAR variable represents the proportion of the water area of each block, and the WAR value is very small in the SPADE result probably because it can't provide sufficient information for modeling SUHI.
