...
3:22 %>%
  purrr::map_dbl(\(.k) st_unidisc(usfi$WAR,.k) %>%
                   psd_spade(usfi$WAR, ., wt))
##  [1]  0.000000000 -0.181786937 -0.169155345 -0.125396131 -0.133455175 -0.131115501 -0.119970690
##  [8] -0.088315304 -0.054531193 -0.058428439 -0.064742210 -0.016081019 -0.021323890 -0.005247945
## [15]  0.010609672  0.010440325  0.016261102  0.002394303  0.017674399  0.048750505
```
...
3:22 %>%
  purrr::map_dbl(\(.k) st_unidisc(usfi$WAR,.k) %>%
                   cpsd_spade(usfi$SUHI, usfi$WAR, ., wt))
##  [1]         NaN  -0.3910865  -0.3535054  -0.6770723  -0.6521600  -0.5998628  -0.7624360
##  [8]  -1.1612373  -1.9424624  -1.8009497  -1.6812595  -7.1186310  -5.7310788 -23.2948856
## [15]  11.3510521  12.2344850   7.6904733  51.9905042   7.2849128   2.6199094
```
