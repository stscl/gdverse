...
![plot of chunk gozh_uni](man/figures/shegd/gozh_uni-1.png)
...
![plot of chunk gozh_bi](man/figures/shegd/gozh_bi-1.png)
...
![plot of chunk lesh](man/figures/shegd/lesh-1.png)
...
``` r
plot(lesh.m, pie = TRUE, scatter = TRUE,
     pielegend_num = 5, pielegend_zie = 15,
...
![plot of chunk lesh_own](man/figures/shegd/lesh_own-1.png)
...
![plot of chunk lesh_only](man/figures/shegd/lesh_only-1.png)
