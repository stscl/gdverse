...
``` r
wt = sdsfun::spdep_contiguity_swm(ushi)
```
...
## |                   varibale                   |     PID     |
## |:--------------------------------------------:|:-----------:|
## | landscape ∩ dist_cold_heat ∩ urbanbuilt_form | 0.455535905 |
## |       dist_cold_heat ∩ urbanbuilt_form       | 0.408837104 |
## |               urbanbuilt_form                | 0.345728704 |
## |         landscape ∩ urbanbuilt_form          | 0.330273768 |
## |                dist_cold_heat                | 0.123441382 |
## |          landscape ∩ dist_cold_heat          | 0.071538071 |
## |                  landscape                   | 0.004183838 |
## 
