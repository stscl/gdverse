...
## |                                                          variable                                                           |    PID    |
## |:---------------------------------------------------------------------------------------------------------------------------:|:---------:|
## |                PopulationDensity ∩ Population65 ∩ Neighbor_Disadvantage ∩ Beer ∩ MentalHealthPati ∩ Casinos                 | 0.9207981 |
## |         PopulationDensity ∩ Population65 ∩ Neighbor_Disadvantage ∩ Beer ∩ MentalHealthPati ∩ Casinos ∩ X.HouseRent          | 0.8712018 |
## | PopulationDensity ∩ Population65 ∩ Neighbor_Disadvantage ∩ Beer ∩ MentalHealthPati ∩ NatureParks ∩ Casinos ∩ DrinkingPlaces | 0.8510630 |
## |        PopulationDensity ∩ Population65 ∩ Neighbor_Disadvantage ∩ Beer ∩ MentalHealthPati ∩ Casinos ∩ DrinkingPlaces        | 0.8481700 |
## |                     PopulationDensity ∩ Population65 ∩ Neighbor_Disadvantage ∩ Beer ∩ MentalHealthPati                      | 0.8471561 |
## 
##  --------- IDSA model performance evaluation: --------
##  * Number of overlay zones :  33 
##  * Percentage of finely divided zones :  0.002798507 
##  * Number of individual explanatory variables :  6 
##  
##  ## Different of response variable between a pair of overlay zones:
## 
## |  zone1st   |  zone2nd   | Risk |
## |:----------:|:----------:|:----:|
## | zoneBeer_2 | zoneBeer_3 |  No  |
## | zoneBeer_2 | zoneBeer_6 |  No  |
## | zoneBeer_2 | zoneBeer_7 |  No  |
## | zoneBeer_2 | zoneBeer_8 |  No  |
## | zoneBeer_2 | zoneBeer_9 |  No  |
## 
