...
## # ℹ 6 more variables: `Variable1 and Variable2 interact Q-statistics` <dbl>,
## #   `Variable1 P-value` <dbl>, `Variable2 P-value` <dbl>,
## #   `Variable1 and Variable2 interact P-value` <dbl>, `Variable1 SPD` <dbl>,
## #   `Variable2 SPD` <dbl>
```
