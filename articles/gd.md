...
This vignette explains how to run **native geographic detector(GD)** in
**gdverse** package.
...
In file `NTDs.gpkg`, `disease` layer is the dependent variable, which is
...
![](../reference/figures/gd/NTDs_map-1.png)
...
![](../reference/figures/gd/rd-1.png)

You can change the significant interval by assign `alpha` argument,the
...
![](../reference/figures/gd/ed-1.png)

You can also change the significant interval by assign `alpha`
...
![](../reference/figures/gd/gd_all-1.png)
